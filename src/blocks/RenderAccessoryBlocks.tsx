...
import { Accessory } from '@/payload-types'
...
type Props = {
  blocks: Exclude<Accessory['layout'], undefined> // safer als unknown
}

export const RenderAccessoryBlocks: React.FC<Props> = ({ blocks }) => {
