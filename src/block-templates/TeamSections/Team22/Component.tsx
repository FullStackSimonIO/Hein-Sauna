...
import type { Team22 as Team22Props } from '@/payload-types'

export const Team22: React.FC<Team22Props> = ({ tagline, heading, description, teamMembers }) => {
...
const TeamMember = ({
  ...
  member: Team22Props['teamMembers'][number]
  className?: string
}) => {
