...
import type { Team1 as Team1Props } from '@/payload-types'
...
export const Team1: React.FC<Team1Props> = ({
  tagline,
  heading,
  description,
  teamMembers,
  ...
  return (
    <section id="team-1" className="px-[5%] py-16 md:py-24 lg:py-28">
...
const TeamMember = ({ member }: { member: Team1Props['teamMembers'][number] }) => {
