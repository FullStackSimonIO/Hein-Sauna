...
import type { Team16 as Team16Props } from '@/payload-types'
...
export const Team16: React.FC<Team16Props> = ({
  tagline,
  heading,
  description,
  teamMembers,
  ...
  return (
    <section id="team-16" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        {footerContent && (
          <div className="mx-auto mt-14 w-full max-w-md text-center md:mt-20 lg:mt-24">
            ...
            {footerContent.description && <RichText data={footerContent.description} />}
            {footerContent.button && (
              <div className="mt-6 flex items-center justify-center gap-x-4 text-center md:mt-8">
                <CMSLink {...footerContent.button} />
              </div>
            )}
          </div>
        )}
...
const TeamMember = ({ member }: { member: Team16Props['teamMembers'][number] }) => {
