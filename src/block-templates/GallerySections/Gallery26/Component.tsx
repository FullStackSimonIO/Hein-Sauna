...
import type { Gallery26 as Gallery26Props } from '@/payload-types'

export const Gallery26: React.FC<Gallery26Props> = ({ heading, description, images }) => {
  ...
  return (
    <section id="gallery-26" className="overflow-hidden py-16 md:py-24 lg:py-28">
